    ...
    datasets: [
      {
        ...
        backgroundColor: [
          ...uniqueIncomeDescriptions.map(() => '#28a745'), // Green for income
          ...uniqueExpenseDescriptions.map(() => '#dc3545')  // Red for expenses
        ],
        hoverBackgroundColor: [
          ...uniqueIncomeDescriptions.map(() => '#218838'), // Darker green for income hover
          ...uniqueExpenseDescriptions.map(() => '#c82333')  // Darker red for expense hover
        ],
        borderWidth: 2,
        borderColor: '#fff',
      },
